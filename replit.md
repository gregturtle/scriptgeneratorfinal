...
Subtitles: Word-based chunking showing 5-6 words at a time instead of full sentences. Breaks at natural pause points (commas, periods) when possible for better readability. Timing is proportional to word count with minimum 0.8 second display per chunk.
